          ...
          <div className={"Landing--values-content" + ( isMobile ? "" : " to-right")}>
            {
              ...
              <>
                ...
                <span className="b7-16-sb subtitle-margin">ZIP 그리고 집</span>
                <span 
                style={{ color: '#787878'}}
                className="b3-14-m">
                  <span>
                    동문들의 정보가 ‘ZIP’ 파일처럼 한 곳에 압축되어 있다는<br />의미이자 우리가 학창시절 먹고 자고 생활했던 ‘집’을<br />나타내는 뜻으로, 이곳에서 지비 공동체가<br />지속적으로 서로 온기를 주고받을 수 있게 합니다. 
                  </span>
                </span>
              </>
              :
          ...
          <div className="Landing--values-content">
            { isMobile ?
              <>
                ...
                <span className="b7-16-sb subtitle-margin">동문 그리고 인기모 정보 아카이브</span>
                <span 
                style={{ color: '#787878'}}
                className="b3-14-m">
